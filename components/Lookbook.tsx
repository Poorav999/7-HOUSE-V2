...
const DEFAULT_ITEMS: LookItem[] = [
  {
    src: "/black_hoodie.png",
    title: "Black / Core",
    caption: "Vol. 04 — Dark Season",
    href: "/shop",
  ...
  {
    src: "/7H_pink_tshirt.png",
    title: "7H Pink Tee",
    caption: "Everyday Essential",
    href: "/shop",
    className: "aspect-square",
  },
  {
    src: "/cyan_hoodie.png",
    title: "Cyan / Vault",
    caption: "Numbered run · 50",
    href: "/drops",
    className: "md:col-span-2 aspect-[16/10]",
  },
  {
    src: "/white_hoodie.png",
    title: "White / Clean",
    caption: "Capsule 03",
    href: "/shop",
